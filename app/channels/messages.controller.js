...
function MessagesCtrl($scope, Actions, $firebaseObject, messages, channelName, profile, channelId) {
...
angular
  ...
  .controller('MessagesCtrl', ['$scope', 'Actions', '$firebaseObject', 'messages', 'channelName', 'profile', 'channelId', MessagesCtrl]);
